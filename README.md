...
- **WebGL / 3D** experiences and **XR / VR** products  
- Frontend-heavy **SaaS dashboards** and **developer tools**  
- Open-source React, tooling, or performance-focused projects

🌱 Currently learning  
- Advanced **React patterns** and **Next.js** for production apps  
- **Three.js** optimizations (instancing, LOD, frustum culling)  
- **System design** and backend scaling patterns

💬 Ask me about  
- **React**, **TypeScript**, and modern frontend architecture  
- **React Three Fiber / Three.js** and building 3D experiences on the web  
- **MERN stack** apps, auth flows, and API design  
- Performance optimization and **web accessibility**

⚡ Fun fact  
- I’m a **frontend engineer** who also loves **strength training, and building fitness apps to help people train better**  
- I’ve shipped multiple **XR/VR applications** and migrated a legacy product to a modern 3D-first platform



## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/linkedin.com/in/syedkhadeer4623) [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:syedkhadeer4623@gmail.com) 
...
![](https://github-readme-stats.vercel.app/api/top-langs/?username=Syedkhadeer-51&theme=dark&hide_border=false&include_all_commits=false&count_private=false&layout=compact)

---
[![](https://visitcount.itsvg.in/api?id=Syedkhadeer-51&icon=0&color=0)](https://visitcount.itsvg.in)
